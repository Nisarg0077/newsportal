    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="dashboard.php" class="block py-1.5 px-4 hover:bg-gray-700 flex items-center">
                        <i class="fa-solid fa-gauge mdi mdi-view-dashboard mr-3"></i>
                        <span> Dashboard </span>
                    </a>
                </li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled ml-6 hidden">
                        ...
                        <li><a href="manage-categories.php" class="block py-1.5 px-4 hover:bg-gray-700">Manage Category</a></li>
                    </ul>
                </li>
